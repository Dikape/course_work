...
<div id="content_writing_style">
	...
	else if ($row_inform_user['type'] == 2) 
	{
		...
		if ($query_get_teacher_course) 
		{
			while ($row_teacher_course = mysql_fetch_array($query_get_teacher_course))
			{
				...
				<a href = "index.php?sidebar=my_courses&delete_course='.$sub_id.'">Видалити</a>
				</button>';
				echo '</div>';
	...
	<div id="courses_menu">
      ...
      <p id="title_video">Курси</p>
         ...
         <li><a href="index.php?sidebar=all_global_courses">Вступити/Відписатися</a><br />
            Стати учасником нового навчального курсу
			Відписатися від існуючого курсу</li>
      <?php } 
      ?>
  ...
  <?php if ($row_inform_user['type'] == 0)
      	echo '<font id="just_error">У вас не має можливості переглядати курси.</font>'; ?>
</div>
